...
User.create!(email: 'admin@sanjuan.com.br', status: :Ativo, tipo: :Administrador,password: 'adminsanjuan', password_confirmation: 'adminsanjuan') if Rails.env.development?
